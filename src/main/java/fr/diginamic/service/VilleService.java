...
public class VilleService {
    ...
    @Transactional
    public Ville ajouterVilleAvecDepartement(Ville ville, String code, Departement departement) {
        // Recherche du département par son code
       departement = departementRepository.findByCode(code);
        if (departement == null) {
            throw new IllegalArgumentException("Département non trouvé avec le code: " + code + departement);
        }
